...
int main(){
    ...
    InitWindow(windowDimensions[0], windowDimensions[1], "first");

    // acceleration from gravity (pixels/frame)/frame
    ...
    AnimData nebData { 
        ...
        {(float)windowDimensions[0], windowDimensions[1] - nebula.height/8.f},
        0,
        1.0/12.0,
        0
    };
    ...
    AnimData neb2Data { 
        {0.0, 0.0, nebula.width/8.f, nebula.height/8.f},
        {(float)windowDimensions[0] + 300, windowDimensions[1] - nebula.height/8.f},
        0,
        1.0/16.0,
        0.0
    };
    ...
    nebulae[5].pos.x = windowDimensions[0] + 1600;
    nebulae[6].pos.x = windowDimensions[0] + 2000;
